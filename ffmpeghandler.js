...
async function combineAudioTracks(name, id) {
    ...
    exec(ffmpeg,
        ['-i', "basesong.mp3",
            ...
            '-i', ("./TempFiles/d" + id + ".mp3"),
            '-i', ("./TempFiles/d" + id + ".mp3"),
            '-filter_complex', audioDelayStr, ("./Output/" + name + id + ".mp3"), "-y"], (error, stdout, stderr) => {
                cleanupTempFiles(id)
            })
}
